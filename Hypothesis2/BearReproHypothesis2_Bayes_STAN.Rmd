...
According to the bayesian gamma models, the linear relationship is better than the log-linear and the quadratic and it is much better than the intercept only model. Therefore, this is the one I will retain
