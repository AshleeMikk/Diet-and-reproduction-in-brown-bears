...
ggplot(pca_points, aes(x = PC1, y = PC2)) +
  geom_point(aes(colour = reprocat), size=4, alpha=0.8)+
  scale_color_manual(breaks=c("Sfem","Wcubs"),
                     labels=c("Single females","Females with offspring"),
                     values = c(P[1],P[7]))+
  geom_segment(data = pca_load, 
...
ggplot(pca_points, aes(x = PC1, y = PC2)) +
  geom_point(aes(colour = CatCort), size=4, alpha=0.8)+
  geom_segment(data = pca_load, 
               aes(x = 0, y = 0, 
                   xend = PC1*5,
                   yend = PC2*5),
...
ggplot(pca_points, aes(x = PC2, y = PC3)) +
  geom_point(size=4, alpha=0.8, aes(color=CatCort))+
  geom_segment(data = pca_load, 
               aes(x = 0, y = 0, 
                   xend = PC2*5,
                   yend = PC3*5),
...
Again, PC2 was strongly associated with year, condition, condition^2, and cortisol, while PC3 is strongly associated with  year, $\delta^{13}$C, and $\delta^{15}$N. These two PCs explained a relatively small amount of variation in the data ()
## PC3 & PC4
...
ggplot(pca_points, aes(x = PC3, y = PC4)) +
  geom_point(aes(colour = Z15N), size=4, alpha=0.8)+
  geom_segment(data = pca_load, 
               aes(x = 0, y = 0, 
                   xend = PC3*5,
                   yend = PC4*5),
...
ggplot(pca_points, aes(x = PC3, y = PC4)) +
  geom_point(aes(colour = Z13C), size=4, alpha=0.8)+
  geom_segment(data = pca_load, 
               aes(x = 0, y = 0, 
                   xend = PC3*5,
                   yend = PC4*5),
