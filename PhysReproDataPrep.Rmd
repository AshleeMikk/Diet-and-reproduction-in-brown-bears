...
# Now I want to only include the bear years included in my data base. I concatonate bear and year to make a string that matches the bearyear.sampled in the bear.reprodata.capture table and will pull out the records that match
...
write.csv(bear.reprodata.capture,"bearreprodata.csv")
```
