...
I ended up just going into excel and doing this manually.Each year a female reproduced received an individual Family Group Number (FG). Then I gave that number to all cubs born to Female f in Year y.

The final file is titled ReproData_FamilyGrouped.csv
