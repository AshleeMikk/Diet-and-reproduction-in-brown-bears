...
We may need to transform cortisol to meet the assumptions of normality
year may be auto-correlated
The body condition metric violates a lot of the linear regression assumptions
We may need to use a generalized rather than general linear regression model.